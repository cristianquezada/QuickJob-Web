...
var valores={
	"Personas que rechazaron: <?php echo $dato['total']; ?>":{valor:<?php echo $dato['total'];?>,color:"gold"},
	"Solicitudes realizadas: <?php echo $quedan;?>":{valor:<?php echo $quedan;?>,color:"silver"},
}
