...
$res=mysql_query("SELECT count(*) as tot FROM solicitud where estadoSolicitud='4' and fkproyecto='$idpro'");
...
var valores={
	"Personas contratadas: <?php echo $dato['total']; ?>":{valor:<?php echo $dato['total'];?>,color:"purple"},
	"Personas primer filtro: <?php echo $dat['tot'];?>":{valor:<?php echo $dat['tot'];?>,color:"pink"},
}
